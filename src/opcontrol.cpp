...
#define gearMult 200
#define driveGearColor pros::E_MOTOR_GEAR_GREEN
#define intakeSensorDelay 500
#define intakeGearColor pros::E_MOTOR_GEAR_GREEN
#define defaultColor teamColor::UNDEFINED
                            ...
                            pros::Motor &ig5)
{
    ...
    ig1.move_velocity(-200 );
    ig2.move_velocity(-200);
    ig3.move_velocity(-200);
    ig4.move_velocity(-200);
    ig5.move_velocity(600);
}

static void set_reject_mode(intakeState &iState,
                            pros::Motor &ig1,
                            pros::Motor &ig2,
                            pros::Motor &ig3,
                            pros::Motor &ig4,
...
void umbc::Robot::opcontrol()
{
    ...
    while (1) {
        ...
        if (controller_master->get_digital_new_press(pros::E_CONTROLLER_DIGITAL_UP)) {
            ...
            left.set_value(true);
            ig7.move_velocity(200);
            ig6.move_velocity(-200);
        }
        ...
        
        {
            ...
            if (colorValue >= get<0>(red) && colorValue < get<1>(red)) {
                ...
                if(teamcolor == teamColor::UNDEFINED){
                    teamcolor = teamColor::RED;
                }
            }
            ...
            while (!ballQueue.empty() && (pros::millis() - ballQueue.front().timeDetected) > intakeSensorDelay) {
                if (iState == intakeState::INTAKE) {
                    ...
                    if (ballQueue.front().color != teamcolor) {
                        ...
                        set_reject_mode(iState, ig1, ig2, ig3, ig4, ig5);
                    } else {
